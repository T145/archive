...
namespace RazorDBxTests
{
	...
	public class KeyValueStoreTests
	{
		...
		static void DoWriteSpeedTests (string basepath)
		{
		...
		public void BulkSetEnumerateAllWithMissingSBT_ThrowAll ()
		{
			...
			// Close and re-open the database to force all the sstable merging to complete.
			Console.WriteLine ("Begin enumeration.");
			RazorDBx.Config.ExceptionHandling = ExceptionHandling.ThrowAll;
		...
		{
			try {
				RazorDBx.Config.ExceptionHandling = ExceptionHandling.AttemptRecovery;
